...
var LOGGERSETTINGS = new LEDA_LOGGER_GENERAL_SETTINGS();
  ...
  LOGGERSETTINGS.trendInterval   = [20];
...
var LOGGER4 = new LEDA_LOGGER("Flowline","Flowline");
  LOGGER4.position   = 0;
  LOGGER4.properties = "Compositional mass fractions,Elevation profile,Heat transfer coefficients,Mass flow rate,Physical regime id,Pressure,Superficial velocities,Temperature,Temperature - average,Temperature - surroundings,Velocities,Volume fraction,Wall temperature - inner surface";
