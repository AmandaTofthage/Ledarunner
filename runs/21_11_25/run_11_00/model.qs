...
var LOGGER4 = new LEDA_LOGGER("Flowline","Flowline");
  LOGGER4.position   = 0;
  LOGGER4.properties = "Elevation profile,Heat transfer coefficients,Mass flow rate,Pressure,Superficial velocities,Temperature,Temperature - average,Temperature - surroundings,Velocities,Wall temperature - inner surface";
...
var LOGGER9 = new LEDA_LOGGER("Downstream_(955m)","Flowline");
  LOGGER9.position   = 955;
  LOGGER9.properties = "Pressure drop,Total masses,Total volumes";
  LOGGER9.type       = "Trend";
