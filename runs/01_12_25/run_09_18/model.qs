...
var BC2 = new LEDA_BC();
  BC2.composition   = [[1]];
  BC2.massFlowrate = [0.0,0.0,20.0,20.0,30.0,30.0,40.0,40.0,50.0,50.0,40.0,40.0,20.0,20.0,0.0];
  BC2.massFractions = [[0,1]];
  BC2.massmoleflag  = "MASS_FRACTIONS";
  BC2.phaseSplit    = "MASS_FRACTIONS";
  BC2.temperature = [273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15,273.15];
  BC2.time = [0.0,100.0,101.0,200.0,201.0,300.0,301.0,400.0,401.0,500.0,501.0,600.0,601.0,700.0,701.0];
  BC2.type          = "MASSIN_1D";
