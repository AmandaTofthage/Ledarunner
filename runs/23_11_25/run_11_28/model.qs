...
var LOGGER4 = new LEDA_LOGGER("Flowline","Flowline");
  LOGGER4.position   = 0;
  LOGGER4.properties = "Elevation profile,Heat transfer coefficients,Mass flow rate,Pressure,Temperature,Temperature - average";
...
var BC1 = new LEDA_BC();
  ...
  BC1.pressure = [8000000.0,10000000.0,12000000.0];
  BC1.temperature = [273.15,313.15,373.15]; 
  BC1.time = [0.0,600.0,1200.0];
