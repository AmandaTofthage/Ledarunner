...
var PVT2 = new LEDA_PVT("default pvt object");
  ...
  PVT2.dRhodP                = [8e-06,3.91e-07,3.91e-07,0];
...
var LOGGERSETTINGS = new LEDA_LOGGER_GENERAL_SETTINGS();
  LOGGERSETTINGS.profileInterval = [200];
  LOGGERSETTINGS.sampleInterval  = [3600];
  LOGGERSETTINGS.time            = [0];
  LOGGERSETTINGS.trendInterval   = [100];
...
var LOGGER2 = new LEDA_LOGGER("Downstream_(955m)","Flowline");
  LOGGER2.position   = 955;
  LOGGER2.properties = "Pressure drop,Total masses,Total volumes";
  LOGGER2.type       = "Trend";

var LOGGER3 = new LEDA_LOGGER("Flowline_100m","Flowline");
  LOGGER3.position   = 100;
  LOGGER3.properties = "Pressure drop,Total masses,Total volumes";
  LOGGER3.type       = "Trend";

var LOGGER4 = new LEDA_LOGGER("Flowline","Flowline");
  LOGGER4.position   = 0;
  LOGGER4.properties = "Elevation profile,Heat transfer coefficients,Mass flow rate,Pressure,Temperature,Temperature - average,Temperature - surroundings,Velocities,Wall temperature - inner surface";
  LOGGER4.type       = "Profile";

var LOGGER5 = new LEDA_LOGGER("Valve","Valve");
  LOGGER5.position   = 950;
  LOGGER5.properties = "Mass flow rate,Opening fraction,Pressure Left,Pressure Right,Pressure drop";
  LOGGER5.type       = "Trend";

var LOGGER6 = new LEDA_LOGGER("InjectionPoint","InjectionPoint");
  LOGGER6.position   = 0;
  LOGGER6.properties = "Average temperature,Mass flow rate,Pressure";
  LOGGER6.type       = "Trend";

var LOGGER7 = new LEDA_LOGGER("Mid_flowline_(500m)","Flowline");
  LOGGER7.position   = 500;
  LOGGER7.properties = "Pressure drop,Total masses,Total volumes";
  LOGGER7.type       = "Trend";

var LOGGER8 = new LEDA_LOGGER("Upstream_(945m)","Flowline");
  LOGGER8.position   = 945;
  LOGGER8.properties = "Pressure drop,Total masses,Total volumes";
  LOGGER8.type       = "Trend";
...
var BC1 = new LEDA_BC();
  ...
  BC1.markAsInlet   = "NO";
  BC1.massFractions = [[0,1]];
  BC1.massmoleflag  = "MASS_FRACTIONS";
  BC1.phaseSplit    = "MASS_FRACTIONS";
  BC1.pressure = [8000000.0];
  BC1.temperature = [283.15]; 
  BC1.time = [0];
  BC1.type          = "PRESSURE_1D";

var BC2 = new LEDA_BC();
  BC2.composition  = [[1]];
  BC2.massFlowrate = [110.0];
  BC2.massmoleflag = "MASS_FRACTIONS";
  BC2.phaseSplit   = "FLASH";
  BC2.temperature = [313.15];
  BC2.time = [0];
  BC2.type         = "MASSIN_1D";
...
var PIPEPROPS1 = new LEDA_PIPEPROPERTIES();
  ...
  PIPEPROPS1.l_mesh      = [0,50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000];
